 ...
 */
final class Version20220202132546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD dlugosc VARCHAR(255) NOT NULL, ADD szerokosc VARCHAR(255) NOT NULL');
    }
