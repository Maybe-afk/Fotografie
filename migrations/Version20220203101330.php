 ...
 */
final class Version20220203101330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test DROP INDEX UNIQ_D87F7E0CE8D49EA0, ADD INDEX IDX_D87F7E0CE8D49EA0 (placeid_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test DROP INDEX IDX_D87F7E0CE8D49EA0, ADD UNIQUE INDEX UNIQ_D87F7E0CE8D49EA0 (placeid_id)');
